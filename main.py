...
from lib import modelv11
from lib import modelv12
...
classifier = modelv12.ClassifierV12(VOCAB_SIZE, MAX_LENGTH, REDUCED_EMBEDDING_DIM, EMBED_DIM, NUM_HEADS, FORWARD_EXPANSION, LAYERS, N_LABELS)
