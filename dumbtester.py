...
from lib.dumb import dumbclassifier
...
model = dumbclassifier(vocab_size, d_model, red_d_model, n_layers, maxlen, ff_exp, heads, N_LABELS)
...
trainer(model, train_dataloader, 2e-4, 15)
