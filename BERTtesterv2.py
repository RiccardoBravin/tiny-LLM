...
red_d_model = 16 # Dimension of token embeddings after reduction
n_layers = 1  # Number of encoder layers
ff_exp = 0.5  # Forward expansion factor
heads = 8  # Number of attention headBERTtesterv2.py
...
model = BERTv2(vocab_size, d_model, red_d_model, n_layers, maxlen, ff_exp, heads, N_LABELS)
...
trainer(model, train_dataloader, 2e-4, 20)
