	...
	for DATASET_NAME in ["sst2", "news", "bull", "limit", "nlu", "snips", "nli", "imdb", "emotion_split"]:
		...
		configs = [
			...
			#    			 	forward_expansion=3, num_layers=2, max_length=dataset_config.max_len, vocab_size=dataset_config.dict_size),	
			ModelConfig( model_name="Embedder_only", embedding_dimension=19, reduced_embedding_dimension=16, number_of_heads=None,
